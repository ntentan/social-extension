...
<div id="third-party-accounts">
    ...
    <br/>
    <a href="signin_with_google" alt="Signin with Google"><img src="<?= load_asset('images/google.png', p('social/assets/images/google.png')) ?>" /></a>
    <a href="signin_with_yahoo" alt="Signin with Yahoo!"><img src="<?= load_asset('images/yahoo.png', p('social/assets/images/yahoo.png')) ?>" /></a>
    <a href="signin_with_facebook" alt="Signin with facebook"><img src="<?= load_asset('images/facebook.png', p('social/assets/images/facebook.png')) ?>" /></a>
